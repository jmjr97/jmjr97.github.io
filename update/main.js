...
const apiUrl =
  'https://api.openweathermap.org/data/2.5/weather?lat=39.308282&lon=-76.449802&units=imperial&appid='
...
setInterval(() => {
  ...
  timeText.innerHTML = formatTime(now)
  dateText.innerHTML = formatDate(now)
